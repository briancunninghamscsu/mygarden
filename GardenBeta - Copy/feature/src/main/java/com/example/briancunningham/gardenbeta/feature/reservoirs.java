...
public class reservoirs extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.airtemplearn) {
            Intent myIntent = new Intent(reservoirs.this, ReservoirslearnActivity.class);
            reservoirs.this.startActivity(myIntent);
            return true;
        }
        if (id == R.id.airtemptolerances) {
            Intent myIntent = new Intent(reservoirs.this, reservoirstolerances.class);
            reservoirs.this.startActivity(myIntent);
            return true;
        }
